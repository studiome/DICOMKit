...
1. JPEG-family and JPEG 2000 transfer syntaxes
2. DICOM writing
3. DICOMweb support
...
currently supports 8-bit and 16-bit monochrome, plus 8-bit RGB Pixel Data;
multi-frame RLE requires a Basic Offset Table. Pixel Padding Value
