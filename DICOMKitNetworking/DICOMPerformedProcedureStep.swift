...
extension DICOMAssociation {
    ...
    /// being so. Use `DICOMModuleValidator` (in `DICOMKitAuthoring`) to check `attributes` against
    ...
    /// responsibility; use `DICOMModuleValidator` (in `DICOMKitAuthoring`) to check them.
